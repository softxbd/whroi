            ...
            <div class="col-lg-12 col-md-12 mb-4">
                <div class="card">
                    ...
                    <div class="card-body pb-2">
                        <form class="mb-3" action="{{ route('update.meet.whro.patients',$patient->id) }}" enctype="multipart/form-data" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <img class="img-thumbnail" width="120" height="120" src="{{ asset('backend/images/'.$patient->thumbnail) }}" alt="">
                                    </div>
